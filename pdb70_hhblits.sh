...
mpirun -np 160 ffindex_apply_mpi ${pdb70_build_dir}/selected_pdb70_fasta.ff{data,index} -i ${pdb70_build_dir}/pdb70_a3m_without_ss.ffindex -d ${pdb70_build_dir}/pdb70_a3m_without_ss.ffdata -- hhblits -i stdin -oa3m stdout -o /dev/null -cpu 1 -d ${uniprot} -n 3 -v 0
